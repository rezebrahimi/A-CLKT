...
tf.flags.DEFINE_string("positive_data_file", "./data/rt-polaritydata/%d_rt-polarity_train.pos"%fold_i, "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/rt-polaritydata/%d_rt-polarity_train.neg"%fold_i, "Data source for the negative data.")
...
def preprocess():
    ...
    ratio_test=0.5
    temp_train=numpy.concatenate((x_train,y_train.reshape((-1,1))),axis=-1)
...
def train(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs", str(2019)))
            print("Writing to {}\n".format(out_dir))
