...
for fold_i in range(0,N_new,fold_size):
  ...
  model = Sequential()
  model.add(Embedding(max_features, 200, input_length=max_rep_length))
  model.add((GRU(200,return_sequences=True,kernel_regularizer=regularizers.l2(0.0001), 
    recurrent_regularizer=regularizers.l2(0.0001), bias_regularizer=regularizers.l2(0.0001))))
  model.add((GRU(200,return_sequences=False,kernel_regularizer=regularizers.l2(0.0001), 
    recurrent_regularizer=regularizers.l2(0.0001), bias_regularizer=regularizers.l2(0.0001))))
...
numpy.savetxt('./%s_Ru.txt'%model_Name,numpy.array(result_cv),fmt='%.4f')
